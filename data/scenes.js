export const scenes = {
  tide_archive: {
    ...
    beats: [
      ...
      { speaker: "王彦祖", text: "门锁没有被撬过。有人从里面离开，又把潮汐记录留在桌上。" },
      { speaker: "王彦祖", text: "录音里有两道频率。一道是气象站的旧信标，另一道……和我第一次听见雾鸣时一模一样。" },
      { speaker: "叙述", text: "海风卷起一张泛黄的值班表。最末一栏写着一个熟悉的日期，墨迹却是新的。" },
      { speaker: "王彦祖", text: "这个日期是我入职的前一晚。调查局的档案里，没有那天的记录。" },
      ...
      { speaker: "叙述", text: "录音末尾传来一声很轻的敲击，像隔着海面回应。王彦祖关掉播放器，第一次没有立刻给出结论。" },
      { speaker: "王彦祖", text: "这件事我会继续查。不是因为它危险——是因为这一次，我不想一个人做决定。" },
